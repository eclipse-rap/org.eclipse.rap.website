...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable
      name="downloadPath"
      select="concat( 'http://www.eclipse.org/downloads/download.php?file=/rt/rap/', '1.5/' )" />
  ...
  <xsl:template match="/">
    <div id="midcolumn">
      ...
      <p>
        Release Date: June 2012, together with Eclipse Juno<br/>
        <a href="/rap/noteworthy/1.5/">New &amp; Noteworthy</a>
      </p>

      <h3>RAP Tooling</h3>

      <p>
        for use with Eclipse 3.7, 3.8 and 4.2
      </p>
      ...
      <p>
        based on Eclipse 3.8
      </p>

      <p>
        Software Site:
        <img src="/rap/images/site.gif"/>
        http://download.eclipse.org/rt/rap/1.5/runtime
      </p>
