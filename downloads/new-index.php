...
<div id="midcolumn">
  ...
  <div class="homeitem3col">
    ...
    <p>
      If you want to develop RAP applications with your custom Eclipse IDE, you
      should install the RAP Tooling.
      The RAP Runtime SDK is already included in the tooling.
      You only need to download it if you are creating a custom target platform.
    </p>
  </div>
