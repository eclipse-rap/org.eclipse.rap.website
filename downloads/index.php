...
<div id="midcolumn">
    ...
    <div class="homeitem3col">
      ...
      <p style="margin: 10px"><b>1.2 RC4 Build</b></p>
      <p style="margin: 10px 10px 10px 20px">
        ...
        <br />
        <a href="http://www.eclipse.org/downloads/download.php?file=/rt/rap/1.2/tooling/rap-tooling-1.2.0-RC4-20090609-1305.zip">
          <img src="../images/icon_save.gif" alt="Update Site Zip"/>
          &nbsp;&nbsp;
          rap-tooling-1.2.0-RC4-20090609-1305.zip
        </a>
    ...
    <div class="homeitem3col">
      ...
      <p style="margin: 10px 10px 10px 20px">
        <a href="http://www.eclipse.org/downloads/download.php?file=/rt/rap/1.2/target/rap-runtime-1.2.0-RC4-20090609-1255.zip">
          ...
          &nbsp;&nbsp;
          rap-runtime-1.2.0-RC4-20090609-1255.zip
        </a>
