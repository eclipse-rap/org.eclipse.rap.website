...
$pageKeywords = "ajax, rap, eclipse rap, archive, download";
...
<div id="midcolumn">
  ...
  <p>
    <strong>Usage:</strong>
    After downloading, extract the file in a convenient location.
    In your Eclipse IDE, open <b>Window &gt; Preferences</b> and go to the
    <b>Plug-in Development &gt; Target Platform</b> preference page.
    Add a new target platform from the sub-directory <code>eclipse</code> of the
    extracted archive.
    Activate this new target.
    You should see the RAP target platform bundles in the plug-ins list.
  </p>
  ...
  <div class="homeitem3col">
    <h3>RAP Runtime Builds</h3>

    <h4>Archived builds for RAP 1.3</h4>

    <ul>
      <li>RAP 1.3 RC3 build, based on Eclipse 3.6&nbsp;&nbsp;
        ...
        <br />
        <a href="http://www.eclipse.org/rap/noteworthy/news_13RC.php">
          New &amp; Noteworthy
        </a>
      </li>

      <li>RAP 1.3 RC2 build, based on Eclipse 3.6&nbsp;&nbsp;
        <a href="http://www.eclipse.org/downloads/download.php?file=/rt/rap/1.3/rap-runtime-1.3.0-RC2-20100601-1021.zip">
          rap-runtime-1.3.0-RC2-20100601-1021.zip
        </a>
        <br />
        <a href="http://www.eclipse.org/rap/noteworthy/news_13RC.php">
          New &amp; Noteworthy
      ...
      <li>RAP 1.3 RC1 build, based on Eclipse 3.6&nbsp;&nbsp;
        <a href="http://www.eclipse.org/downloads/download.php?file=/rt/rap/1.3/rap-runtime-1.3.0-RC1-20100518-1222.zip">
          rap-runtime-1.3.0-RC1-20100518-1222.zip
        </a>
        <br />
        <a href="http://www.eclipse.org/rap/noteworthy/news_13RC.php">
          New &amp; Noteworthy
      ...
      <li>RAP 1.3 M7 milestone build, based on Eclipse 3.6&nbsp;&nbsp;
        ...
        <br />
        <a href="http://www.eclipse.org/rap/noteworthy/news_13M7.php">
          New &amp; Noteworthy
        </a>
      </li>
      ...
      <li>RAP 1.3 M3 milestone build, based on Eclipse 3.6&nbsp;&nbsp;
        ...
        <br />
        <a href="http://www.eclipse.org/rap/noteworthy/news_13M3.php">
          New &amp; Noteworthy
        </a>
      </li>
    ...
    <h4>Archived builds for RAP 1.2</h4>
