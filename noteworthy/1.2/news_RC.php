...
<div id="midcolumn">
  <h1>RAP 1.2 Release Candidates - New and Noteworthy</h1>
    ...
    <h2>RC5</h2>
    <p>
      <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced&short_desc_type=allwordssubstr&short_desc=&classification=RT&product=RAP&target_milestone=1.2&long_desc_type=allwordssubstr&long_desc=&bug_file_loc_type=allwordssubstr&bug_file_loc=&status_whiteboard_type=allwordssubstr&status_whiteboard=&keywords_type=allwords&keywords=&bug_status=RESOLVED&bug_status=VERIFIED&bug_status=CLOSED&emailtype1=substring&email1=&emailtype2=substring&email2=&bugidtype=include&bug_id=&votes=&chfieldfrom=&chfieldto=Now&chfieldvalue=&cmdtype=doit&order=Reuse+same+sort+as+last+time&field0-0-0=noop&type0-0-0=noop&value0-0-0=">
      This list</a> shows all bugs that were fixed in the RC5 build
      which is now available for 
      <a href="http://www.eclipse.org/rap/downloads/">download</a>.
    </p>
    ...
    <ul>
      <li><a href="news_M7.php">New for RAP 1.2 M7 (May 11, 2009)</a></li>
      <li><a href="news_M6.php">New for RAP 1.2 M6 (March 23, 2009)</a></li>
      <li><a href="news_M5.php">New for RAP 1.2 M5 (February 16, 2009)</a></li>
      <li><a href="news_M4.php">New for RAP 1.2 M4 (January 12, 2009)</a></li>
