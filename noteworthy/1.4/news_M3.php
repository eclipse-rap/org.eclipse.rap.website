...
<p>
  ...
  milestone build 1.4 M3 (November 2010).
  <!--
...
<p>
  <a href="https://bugs.eclipse.org/bugs/buglist.cgi?classification=RT&product=RAP&target_milestone=1.4+M3&bug_status=RESOLVED&bug_status=VERIFIED&bug_status=CLOSED&query_format=advanced">
...
$news = new Noteworthy( 'news_14.xml', 'M3', $header, $footer );
$html = $news->getHtml();
