...
<div id="midcolumn">
  ...
  <ul>
    <li>
      <a href="1.5/news_M4.php">RAP 1.5 M4</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the 4<sup>th</sup> milestone
        build for RAP 1.5 (M4, November 11, 2011).
      </p>
    </li>
    <li>
      <a href="1.5/news_M3.php">RAP 1.5 M3</a>
      <p style="margin-top: 5px">
    ...
    <li>
      ...
      <p style="margin-top: 5px">
        ...
        build for RAP 1.5 (M2, October 30, 2011).
      </p>
    </li>
    <li>
      <a href="1.5/news_M1.php">RAP 1.5 M1</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the first milestone
        build for RAP 1.5 (M1, August 22<sup>nd</sup>, 2011).
      </p>
    </li>
    <li>
      <a href="1.4/">RAP 1.4 Release</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the 1.4 release.
      </p>
    </li>
    <li>
    ...
    <li>
      <a href="1.4/news_M6.php">RAP 1.4 M6</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the sixth milestone
        build for RAP 1.4 (M6, March 18<sup>th</sup>, 2011).
      </p>
    </li>
    <li>
      <a href="1.4/news_M5.php">RAP 1.4 M5</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the fifth milestone
        build for RAP 1.4 (M5, available for
        <a href="/rap/downloads/">download</a>).
      </p>
    </li>
    <li>
      <a href="1.4/news_M4.php">RAP 1.4 M4</a>
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the fourth milestone
        build for RAP 1.4 (M4, available for
        <a href="/rap/downloads/">download</a>).
      </p>
    </li>
    <li>
      ...
      <p style="margin-top: 5px">
        ...
        build for RAP 1.4 (M3, available for
        <a href="/rap/downloads/">download</a>).
      </p>
    </li>
    <li>
      ...
      <p style="margin-top: 5px">
        Listed are the noteworthy things available in the second milestone
        build for RAP 1.4 (M2, available for
        <a href="/rap/downloads/">download</a>).
      </p>
    </li>
    <li>
