...
<div id="midcolumn">
  <h1>1.3.2 Service Release</h1>
  <p>
    RAP 1.3.2 is a service release to fix serious defects present in the
    <a href="/rap/noteworthy/1.3/">RAP 1.3 release</a>.
  </p>
  <p>
    The following bugzilla query lists all defects that have been fixed in this
    service release:
    <a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=advanced&classification=RT&product=RAP&status_whiteboard_type=allwordssubstr&status_whiteboard=sr132&bug_status=RESOLVED&bug_status=VERIFIED&bug_status=CLOSED">
    Bugs fixed in the 1.3.2 release</a>.
  </p>
  <p>
