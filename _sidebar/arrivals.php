<div class="sideitem">
  ...
  <div class="terminal">
    ...
    <div class="terminal-row">
      ...
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text terminal-landing">ARRIVED</span>
      </span>
    </div>
    ...
    <div class="terminal-row">
      ...
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">NOV 29</span>
      </span>
    </div>
    ...
    <div class="terminal-row">
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">RAP 2.2 RC2</span>
      </span>
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">DEC 6</span>
      </span>
    </div>
    ...
    <div class="terminal-row">
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">RAP 2.2</span>
      </span>
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
