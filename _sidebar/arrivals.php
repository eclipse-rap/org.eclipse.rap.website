<div class="sideitem">
  ...
  <div class="terminal">
    ...
    <div class="terminal-row">
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">RAP 3.0 M1</span>
      </span>
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text terminal-arrived">ARRIVED</span>
    ...
    <div class="terminal-row">
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">RAP 3.0 M2</span>
      </span>
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text terminal-arrived">ARRIVED</span>
    ...
    <div class="terminal-row">
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">RAP 3.0 M3</span>
      </span>
      <span class="terminal-field">
        <span class="terminal-overlay"></span>
        <span class="terminal-text">NOV 14</span>
      </span>
    </div>
